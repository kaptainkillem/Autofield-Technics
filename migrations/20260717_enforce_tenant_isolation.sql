...
DROP POLICY IF EXISTS "Anyone can submit quote requests" ON public.quotes;
DROP POLICY IF EXISTS "Clients Manage Own Quotes"       ON public.quotes;
...
DROP POLICY IF EXISTS "Clients Manage Own Vehicles"   ON public.vehicles;
...
DROP POLICY IF EXISTS "Allow admins full control of seo registry" ON public.seo_registry;
DROP POLICY IF EXISTS "Enable public read access for seo_registry" ON public.seo_registry;
