    ...
    <div className="flex flex-col gap-4">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          ...
          <span className="bg-grey-lightest text-grey border border-grey-medium/20 rounded-base px-3 py-1 text-xs font-bold">
        ...
        <table className="w-full text-left border-collapse text-sm">
          ...
          <tbody className="divide-y divide-grey-light">
            {filtered.map((service) => (
              <tr key={service.id} className="hover:bg-grey-lightest/40 transition">
