      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-start">
        {filteredReviews.length === 0 ? (
          <div className="col-span-full bg-white border border-grey-medium/10 rounded-base p-12 text-center text-grey text-sm shadow-sm flex flex-col items-center justify-center gap-4">
            <div className="p-4 bg-grey-lightest text-grey rounded-full border border-grey-medium/5">
          ...
          filteredReviews.map((review) => (
            ...
            >
              <div className="flex flex-col gap-2">
                ...
                {/* Testimonial Text */}
                <p className="text-xs text-grey-dark leading-relaxed italic bg-grey-lightest p-3 rounded-base border border-grey-medium/5 mt-1">
